...
def get_all_item(keywords, pages):
    ...
    for content in contents:
        ...
        review = content.find('span', {'class':'s-item__reviews-count'}) # add feature review
        # test = content.find('span',{'class':'s-item__reviews-count'}).find('span',{'class':'clipped'})
        ...
        data_dict = {
            ...
            'soldprice': soldprice,
            'link': link,
            'review': review, # add feature review
            # 'test' : test,
        }
